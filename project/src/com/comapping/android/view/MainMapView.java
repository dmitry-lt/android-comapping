...
public class MainMapView extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		mRender.draw(mScroller.getCurrX(), mScroller.getCurrY(), this.getWidth(), this.getHeight(), canvas);
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_UP: {
			...
			mScroller.fling(mScroller.getCurrX(), mScroller.getCurrY(), -vx, -vy, 0, mRender.getWidth(), 0, mRender.getHeight());
