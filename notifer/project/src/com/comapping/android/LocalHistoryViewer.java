			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Cursor cursor = LocalHistoryViewer.this.getContentResolver()
						.query(
								...
								null,
								LocalHistoryProvider.Columns._ID + "="
										+ Tag.valueOf(tagf).id.get(arg2), null,
								null);

				/*
				 * Cursor cursor =
				 * LocalHistoryViewer.this.getContentResolver().query(
				 * LocalHistoryProvider.CONTENT_URI, null, "id=$", new
				 * String[]{Tag.valueOf(tagf).id.get(arg2).toString()}, null);
				 */
